...
const UI_SELECTORS = {
    ...
    toggleFormBuilderBtn: '#toggleFormBuilderBtn',
    templatesBtn: '#templatesBtn',
    renameTemplateBtn: '#renameTemplateBtn',
    previewJsonBtn: '#previewJsonBtn',
    diagramBtn: '#diagramBtn',
    noTemplateState: '#noTemplateState',
    createTemplatePageBtn: '#createTemplatePageBtn',
    formTitleDisplay: '#formTitleDisplay',
    mainFormContainer: '#mainFormContainer',
    treeViewContainer: '#treeViewContainer',
    treePanelContent: '#treePanelContent',
    diagramPanelContent: '#diagramPanelContent',
    rightPanelTitle: '#rightPanelTitle',
    rightPanelHint: '#rightPanelHint',
